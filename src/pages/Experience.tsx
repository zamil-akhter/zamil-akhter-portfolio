        ...
        <div className="timeline">
          <div className="timeline-item left">
            <div className="timeline-content">
              ...
              <ul className="achievements">
                <li>Developed a scalable backend for a social media platform, including features like user authentication, content management, and real-time messaging.</li>
                <li>Built features including advanced influencer search, real-time chat via Socket.IO, engagement analytics, and integrated payment systems.</li>
                <li>Integrated Redux for efficient state management, improving scalability and reducing load times by 30%.</li>
                <li>Optimized backend performance using Node.js, NestJS, Express.js, MongoDB, Socket.IO, Redis, SQL, PostgreSQL, OpenAI and AWS services.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="timeline-item right">
            <div className="timeline-content">
              ...
              <ul className="achievements">
                <li>Developed a scalable backend for a social media platform, including features like user authentication, content management, and real-time messaging.</li>
                <li>Created responsive web applications using NestJS and Node.js</li>
                <li>Implemented RESTful APIs using NestJS and MongoDB</li>
